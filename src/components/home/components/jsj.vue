<template>
  <div>
    <div class="from-warpper">
      <div class="title">计算机大楼东区停车场停车位实况</div>
  ...
  export default {
    ...
    mounted() {
      window.map = new esmap.ESMap({
        ...
        mapDataSrc: "static/jsj/mapData/", //地图数据所在目录
        mapThemeSrc: "static/jsj/theme/", //地图主题所在目录
        themeID: 1005, //请确保主题目录下存在该主题的数据包000000000
        focusFloor: 1,
